...
const document: Document = {
  ...
  nodes: {
    ...
    "1": {
      id: 1,
      name: null,
      op: { type: "Cube", size: { x: 60, y: 4, z: 40 } },
    },
    ...
    "2": {
      id: 2,
      name: null,
      op: { type: "Cube", size: { x: 60, y: 36, z: 4 } },
    },
    // Position wall at back of base (z = 40 - 4 = 36) and on top (y = 4)
    "3": {
      id: 3,
      name: null,
      op: { type: "Translate", child: 2, offset: { x: 0, y: 4, z: 36 } },
    },
    ...
    "20": {
      id: 20,
      name: null,
      op: { type: "Translate", child: 12, offset: { x: 12.5, y: -7, z: 20 } },
    },
    "21": {
      id: 21,
      name: null,
      op: { type: "Translate", child: 12, offset: { x: 47.5, y: -7, z: 20 } },
    },
    ...
    "22": {
      id: 22,
      name: null,
      op: { type: "Translate", child: 11, offset: { x: 12.5, y: 22, z: 28 } },
    },
    "23": {
      id: 23,
      name: null,
      op: { type: "Translate", child: 11, offset: { x: 47.5, y: 22, z: 28 } },
    },
    ...
    "52": {
      id: 52,
      name: "L-Bracket",
      op: { type: "Translate", child: 51, offset: { x: -30, y: 0, z: -20 } },
    },
  },
  materials: {
    default: {
