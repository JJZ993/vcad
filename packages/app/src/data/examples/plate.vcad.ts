...
const document: Document = {
  ...
  nodes: {
    ...
    "1": {
      id: 1,
      name: null,
      op: { type: "Cube", size: { x: 80, y: 6, z: 60 } },
    },

    // Large center hole (cylinder, radius 6, rotated to point along Y axis)
    "2": {
      id: 2,
      name: null,
      op: { type: "Cylinder", radius: 6, height: 20, segments: 32 },
    },
    // Rotate -90° around X to align cylinder with Y axis
    "3": {
      id: 3,
      name: null,
      op: { type: "Rotate", child: 2, angles: { x: -90, y: 0, z: 0 } },
    },
    // Position at center of plate
    "4": {
      id: 4,
      name: null,
      op: { type: "Translate", child: 3, offset: { x: 40, y: -7, z: 30 } },
    },

    // Small mounting holes (cylinder, radius 2, rotated to point along Y axis)
    // Hole template
    "10": {
      id: 10,
      name: null,
    ...
    "20": {
      id: 20,
      name: null,
      op: { type: "Translate", child: 11, offset: { x: 8, y: -7, z: 8 } },
    },
    // Front-right (72, y, 8)
    "21": {
      id: 21,
      name: null,
      op: { type: "Translate", child: 11, offset: { x: 72, y: -7, z: 8 } },
    },
    // Back-left (8, y, 52)
    "22": {
      id: 22,
      name: null,
      op: { type: "Translate", child: 11, offset: { x: 8, y: -7, z: 52 } },
    },
    // Back-right (72, y, 52)
    "23": {
      id: 23,
      name: null,
      op: { type: "Translate", child: 11, offset: { x: 72, y: -7, z: 52 } },
    },
    ...
    "24": {
      id: 24,
      name: null,
      op: { type: "Translate", child: 11, offset: { x: 8, y: -7, z: 30 } },
    },
    // Right edge (72, y, 30)
    "25": {
      id: 25,
      name: null,
      op: { type: "Translate", child: 11, offset: { x: 72, y: -7, z: 30 } },
    },
    // Front edge (40, y, 8)
    "26": {
      id: 26,
      name: null,
      op: { type: "Translate", child: 11, offset: { x: 40, y: -7, z: 8 } },
    },
    // Back edge (40, y, 52)
    "27": {
      id: 27,
      name: null,
      op: { type: "Translate", child: 11, offset: { x: 40, y: -7, z: 52 } },
    },
    ...
    "52": {
      id: 52,
      name: "Mounting Plate",
      op: { type: "Translate", child: 51, offset: { x: -40, y: 0, z: -30 } },
    },
  },
  materials: {
    default: {
